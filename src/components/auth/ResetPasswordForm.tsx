  ...
  if (resetSuccess) {
    return (
      <div className="space-y-6 text-center">
        ...
        <div>
          <h2 className="text-2xl font-bold text-text">Password reset successful</h2>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="reset-password" className="block text-sm font-medium text-text mb-2">
            New password
          </label>
          <div className="relative">
            ...
            <input
              ...
              } bg-background text-text placeholder-muted-foreground py-3 pl-11 pr-12 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20`}
              placeholder="••••••••"
        ...
        <div>
          <label htmlFor="reset-confirm-password" className="block text-sm font-medium text-text mb-2">
      ...
      <div className="rounded-lg bg-accent p-4">
        <p className="text-sm font-medium text-accent-foreground">Password requirements:</p>
        <ul className="mt-2 space-y-1 text-sm text-accent-foreground/80">
          <li className="flex items-center gap-2">
            <CheckCircle2 className={`h-4 w-4 ${formData.password.length >= 8 ? 'text-green-600 dark:text-green-400' : 'text-muted-foreground'}`} aria-hidden="true" />
            At least 8 characters
          </li>
          <li className="flex items-center gap-2">
            <CheckCircle2 className={`h-4 w-4 ${/[A-Z]/.test(formData.password) ? 'text-green-600 dark:text-green-400' : 'text-muted-foreground'}`} aria-hidden="true" />
          ...
          <li className="flex items-center gap-2">
            <CheckCircle2 className={`h-4 w-4 ${/\d/.test(formData.password) ? 'text-green-600 dark:text-green-400' : 'text-muted-foreground'}`} aria-hidden="true" />
            One number
          </li>
        </ul>
      </div>
